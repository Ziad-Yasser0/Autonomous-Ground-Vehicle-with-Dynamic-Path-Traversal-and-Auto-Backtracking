...
/****************************************** TIMER 0 REGISTERS *************************************/
/**************************************************************************************************/
#define     TIM0_u8_TCCR0_REG		      *((volatile uint8 *)(0x53))		// Timer/Counter0 Control Register
...
#define     TIM0_u8_TCNT0_REG		      *((volatile uint8 *)(0x52))		// Timer/Counter0 Register

#define     TIM0_u8_OCR0_REG		      *((volatile uint8 *)(0x5C))		// Output Compare0 Register

#define     TIM0_u8_TIMSK_REG		      *((volatile uint8 *)(0x59))		// Timer0 Mask Register
...
#define     TIM0_u8_TIFR_REG              *((volatile uint8 *)(0x58))		// Timer/Counter0 Interrupt Flag Register
...
/****************************************** TIMER 1 REGISTERS *************************************/
/**************************************************************************************************/
#define		TIM1_u8_TCCR1A_REG			  *((volatile uint8 *)(0x4F))		// Timer/Counter 1 Control Register A
...
#define		TIM1_u8_TCCR1B_REG			  *((volatile uint8 *)(0x4E))		// Timer/Counter 1 Control Register B
...
#define		TIM1_u8_TCNT1L_REG			  *((volatile uint8 *)(0x4C))		// Timer/Counter 1 Low Register
#define		TIM1_u8_TCNT1H_REG			  *((volatile uint8 *)(0x4D))		// Timer/Counter 1 High Register
#define		TIM1_u16_TCNT1_REG			  *((volatile uint16 *)(0x4C))		// Timer/Counter 1 Register

#define		TIM1_u8_OCR1AL_REG			  *((volatile uint8 *)(0x4A))		// Output Compare 1 Channel A Low Register
#define		TIM1_u8_OCR1AH_REG			  *((volatile uint8 *)(0x4B))		// Output Compare 1 Channel A High Register
#define     TIM1_u16_OCR1A_REG			  *((volatile uint16 *)(0x4A))		// Output Compare 1 Channel A Register

#define		TIM1_u8_OCR1BL_REG			  *((volatile uint8 *)(0x48))		// Output Compare 1 Channel B Low Register
#define		TIM1_u8_OCR1BH_REG			  *((volatile uint8 *)(0x49))		// Output Compare 1 Channel B High Register
#define     TIM1_u16_OCR1B_REG			  *((volatile uint16 *)(0x48))		// Output Compare 1 Channel B Register

#define		TIM1_u8_ICR1L_REG			  *((volatile uint8 *)(0x46))		// Input Capture 1 Low Register
#define		TIM1_u8_ICR1H_REG			  *((volatile uint8 *)(0x47))		// Input Capture 1 High Register
#define     TIM1_u16_ICR1_REG			  *((volatile uint16 *)(0x46))		// Input Capture 1 Register
